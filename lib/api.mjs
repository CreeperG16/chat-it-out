...
// TODO: don't use process.env here
...
async function postMessage(content, authorId, channelId, token) {
    const ENDPOINT = "https://wkuimailekpioxrlteqk.supabase.co/rest/v1/messages";

    const { data: messageResult, error: messageErr } = await post(
        ENDPOINT,
        { content, room_id: channelId, author_id: authorId },
        token
    );
...
export { getChannels, getMessages, getProfiles, getProfile, postMessage };
